(module
  ...
  block $folding-inner0
   ...
   if
    ...
    if
     ...
     local.get $0
     i32.store
     block $__inlined_func$~lib/rt/itcms/__renew$132
      i32.const 1073741820
      local.get $4
      i32.const 1
      i32.shl
      ...
      if
       ...
       local.get $4
       local.set $3
       br $__inlined_func$~lib/rt/itcms/__renew$132
      end
      local.get $5
      local.get $7
      i32.load offset=12
 ...
 (func $export:assembly/index/quantize (param $0 i32) (result i32)
  ...
  block $folding-inner1
   ...
   local.get $0
   i32.store
   block $__inlined_func$assembly/index/quantize$3 (result i32)
    global.get $~lib/memory/__stack_pointer
    i32.const 12
    i32.sub
    global.set $~lib/memory/__stack_pointer
    block $folding-inner0
     ...
     global.set $~lib/memory/__stack_pointer
     local.get $0
     br $__inlined_func$assembly/index/quantize$3
    end
    br $folding-inner1
   end
   local.set $0
