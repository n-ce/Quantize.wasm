(module
 ...
 (data $9 (i32.const 476) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s\00\00\00")
 ...
 (data $13 (i32.const 704) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00A\00\00\00\02\1a\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (export "quantize" (func $export:assembly/index/quantize))
 (export "default" (func $export:assembly/index/quantize))
 (start $~start)
       ...
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         block $~lib/object/Object
          ...
          i32.sub
          i32.load
          br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/typedarray/Uint8ClampedArray $~lib/array/Array<f64> $~lib/array/Array<i32> $invalid
         end
         return
        end
        return
 ...
 (func $assembly/index/quantize (param $array i32) (result i32)
  (local $length i32)
  (local $amount i32)
  (local $r i32)
  (local $g i32)
 ...
 (func $export:assembly/index/quantize (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
